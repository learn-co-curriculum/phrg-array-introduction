...
<p data-visibility='hidden'>View <a href='https://learn.co/lessons/array-introduction' title='Array Introduction'>Array Introduction</a> on Learn.co and start learning to code for free.</p>
